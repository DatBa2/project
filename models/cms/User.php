...
VALUES(:username, :password, :first_name, :last_name, :phone, :address, :email, :avatar, :jobs, :facebook, :status)");
    ...
    public function update($id) {
        $obj_update = $this->connection
            ->prepare("UPDATE users SET phone=:phone, 
            address=:address, email=:email, avatar=:avatar, jobs=:jobs, last_login=:last_login, facebook=:facebook, status=:status, updated_at=:updated_at
             WHERE id = $id");
        $arr_update = [
            ':phone' => $this->phone,
            ':address' => $this->address,
    ...
    public function updateLogin($id) {
        $obj_update = $this->connection
            ->prepare("UPDATE users SET last_login=:last_login, status=:status WHERE id = $id");
        $arr_update = [
            ':last_login' => $this->last_login,
            ':status' => $this->status,
        ];
