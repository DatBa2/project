...
require_once 'models/cms/Pagination.php';
...
class CategoryController extends Controller
{
      ...
      public function index()
      {
          ...
          $_SESSION['count']['count_category'] = $count_total;
          ...
          $this->content = $this->render('views/cms/categories/index.php', [
      ...
      public function create()
      {
        ...
        $this->content = $this->render('views/cms/categories/create.php');
      ...
      public function update()
      {
        ...
        //lấy nội dung view create.php
        $this->content = $this->render('views/cms/categories/update.php', ['category' => $category]);
        //gọi layout để nhúng nội dung view create vừa lấy đc
        require_once 'views/cms/layouts/main.php';
      }
      ...
      public function delete()
      {
        ...
        $category_model = new Category();
        $dir_uploads = __DIR__ . '/../../assets/uploads';
        $delete_avatar = $category_model->getCategoryById($id);
        @unlink($dir_uploads . '/' . $delete_avatar['avatar']);
      ...
      public function detail()
      {
        ...
        $category = $category_model->getCategoryById($id);
        //lấy nội dung view create.php
        $this->content = $this->render('views/cms/categories/detail.php', [
          'category' => $category
        ]);
