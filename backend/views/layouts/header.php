            ...
            <div class="left">
                ...
                <div class="left__content">
                    ...
                    <ul class="left__menu">
                        ...
                        <li class="left__menuItem">
                            <a href="<?php echo "/bai3/frontend/index.php"; ?>" class="left__title" target="_blank" ><img src="assets/assets/icon-users.svg" alt="">Trang Web</a>
                        </li>
                        <li class="left__menuItem">
                            <a href="<?php echo "#"; ?>" class="left__title"><img src="assets/assets/icon-users.svg" alt="">Khách Hàng</a>
                        </li>
                        <li class="left__menuItem">
                            <a href="<?php echo "index.php?controller=order&action=index"; ?>" class="left__title"><img src="assets/assets/icon-book.svg" alt="">Đơn Đặt Hàng</a>
                        </li>
<!--                        <li class="left__menuItem">-->
...
<!--                        </li>-->
                        ...
                        <li class="left__menuItem">
                            <a href="<?php echo "index.php?controller=user&action=logout&id=".$_SESSION['user']['id']; ?>" class="left__title"><img src="assets/assets/icon-logout.svg" alt="">Đăng Xuất</a>
                        </li>
                    </ul>
                </div>
            </div>