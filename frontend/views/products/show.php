                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="" style="text-align: center; margin-bottom: 15px">
                            <img width="400px" class="product-big-img" src="../backend/assets/uploads/<?php echo $product[0]['avatar'] ?>" alt="">
                        </div>
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                <div class="pt active" data-imgbigurl="img/product-single/product-1.jpg"><img
                                        src="../backend/assets/uploads/<?php echo $product[0]['avatar'] ?>" alt=""></div>
